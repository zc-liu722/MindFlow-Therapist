...
async function buildSystemPrompt(input: {
  ...
  const paceInstructions =
    input.pace === "fast"
      ? [
          "当前速度偏好：快速。",
          "请把快速理解为更积极的推进倾向，而不是固定轮次或硬性收尾要求。",
          "请更快聚焦最核心的困扰，少做冗长铺垫。",
          "在充分回应情绪的前提下，更主动地帮助用户提炼重点、形成当下可执行的下一步。",
          "只有在用户的表达已经得到承接、主题开始稳定、情绪允许时，才可以自然尝试轻度收束；不要因为节奏较快而突然结束会谈。",
          "单次回复尽量简洁，通常以 1 次反映 + 1 个聚焦问题或 1 个收束建议为主。"
        ]
      : input.pace === "medium"
        ? [
            "当前速度偏好：中速。",
            "请把中速理解为自然均衡的推进倾向，而不是固定轮次或硬性收尾要求。",
            "请保持自然均衡的节奏，既不要过度拖慢，也不要急着收尾。",
            "在回应情绪之后，适度帮助用户聚焦重点并推进到下一步。",
            "如果用户仍在持续展开新的重要内容，请继续陪伴和澄清，而不是机械进入总结。",
            "单次回复通常以 1 次回应 + 1 个聚焦问题或 1 个简短整理为主。"
          ]
      : [
          "当前速度偏好：慢速。",
          "请把慢速理解为更保守的推进倾向，而不是固定轮次或无限延长会谈的要求。",
          "请优先体现倾听与陪伴，不要急着收尾或推进解决方案。",
          "允许多一些情绪反映、体验澄清和细腻跟随，帮助用户把感受说得更完整。",
          "即使后续开始整理，也先以轻收束为主，确认用户的表达已经自然沉淀后再考虑更完整的总结。",

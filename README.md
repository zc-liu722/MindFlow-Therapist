...
- 线上地址：[https://mindflow-therapist-web.onrender.com](https://mindflow-therapist-web.onrender.com)
- 当前已部署在 `Render`
...
项目使用本地文件数据库，不适合直接部署到不提供持久本地磁盘的静态或无状态托管平台。若需要复刻公网部署，更推荐使用带持久磁盘的 Node 服务环境，例如 `Render`。
